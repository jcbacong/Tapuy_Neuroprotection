...
function processFile(input, output, file, suffix) {
	...
	blank = "/Users/jcbacong/Documents/BCH 205/BZ555/blank 06-24-2022.tif";
	...
	selectWindow(file);
	imageCalculator("Subtract create", file, "blank 06-24-2022.tif");
//	imageCalculator("Subtract create", "Result of "+file, "blank.tif");
	...
	run("Analyze Particles...", "size=4-150 circularity=0.01-1.00 show=[Overlay Masks] display exclude add");
